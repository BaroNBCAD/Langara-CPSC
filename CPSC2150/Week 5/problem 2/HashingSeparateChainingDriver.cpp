...
void insert_function(HashingSeparateChaining &test){
...
void delete_function(HashingSeparateChaining &test){
    int numDel = 0;
...
void search_function(HashingSeparateChaining &test){
    int numSea = 0;
...
void display_function(HashingSeparateChaining &test){
    test.Display();
    return;
}
